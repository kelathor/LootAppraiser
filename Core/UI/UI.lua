...
function UI.ShowTimerWindow()
    ...
    -- tab --
    private.TIMER_UI_TAB = CreateFrame("Frame", nil, private.TIMER_UI.frame, BackdropTemplateMixin and "BackdropTemplate")
    ...
    LA.UI.b1 = CreateFrame("Button", nil, private.TIMER_UI_TAB, BackdropTemplateMixin and "BackdropTemplate")
...
--                private.OnBtnStartSessionClick()
    ...
    local b2 = CreateFrame("Button", nil, private.TIMER_UI_TAB, BackdropTemplateMixin and "BackdropTemplate")
    b2:SetSize(20, 20)
